        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed mb-6">
              Your trusted partner for IT hardware, software, networking products, and technical support solutions in Bengaluru.
            </p>
          ...
          <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-blue-200 text-sm">Monday – Saturday</p>
                <p className="text-white font-semibold">10:00 AM – 8:00 PM</p>
                <p className="text-blue-200 text-sm mt-2">Sunday: Closed</p>
              </div>
            </div>
          </div>
        </div>
